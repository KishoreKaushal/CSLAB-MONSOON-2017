...
typedef _DNODE_  _CNODE_ ;

typedef _DLINKED_LIST_   _CLINKED_LIST_ ;


void initializeCList(_CLINKED_LIST_*);                /* Initializes the circular linked list */
int addCHead(_CLINKED_LIST_*, void*);                 /* Adds data to the circular linked lists's head */
int addCTail(_CLINKED_LIST_*, void*);                 /* Adds data to the circular linked list's tail */
void removeCNode(_CLINKED_LIST_*, _CNODE_*);               /* Removes a node from the circular linked list */
_CNODE_ *getCNode(const _CLINKED_LIST_*, COMPARE , void*);   /* Returns a pointer to the node containing a specific data item */
void displayCLinkedList(const _CLINKED_LIST_*, DISPLAY);    /* Displays the circular linked list */
int ClistEmpty(const _CLINKED_LIST_*);
void freeCList(_CLINKED_LIST_ *); /*Free the allocated circular linked list from the memory*/
